...
!(function () {
  const e = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }),
    t = {
      successIcon:
  ...
  (l.rel = 'preconnect'), (l.href = 'https://fonts.gstatic.com'), l.setAttribute('crossorigin', '');
  ...
  var o = document.getElementById('sms-widget-script'),
    r = o.getAttribute('customerPhone'),
    d = o.getAttribute('customerName'),
    C = o.getAttribute('transactionID'),
    a = o.getAttribute('paymentAmount'),
    s = o.getAttribute('paymentNote'),
    p = o.getAttribute('accessToken'),
    c = o.getAttribute('transactionRemain'),
    h = (o.getAttribute('currency'), o.getAttribute('formType'));
  function y(e) {
    const t = cryptoBrowserify.randomBytes(32),
      n = cryptoBrowserify.randomBytes(16),
      l = cryptoBrowserify.publicEncrypt(
        {
      ...
      i = cryptoBrowserify.createCipheriv('aes-256-gcm', t, n),
      o = buffer.Buffer.concat([i.update(e, 'utf8'), i.final()]),
      r = i.getAuthTag();
    return buffer.Buffer.concat([l, n, o, r]).toString('base64');
  }
  ...
  (u.innerHTML = t.loadingSvg), g.appendChild(u);
  ...
  (f.style.position = 'fixed'),
    ...
    (f.style.fontFamily = 'Inter'),
    (f.style.color = '#2D2B32');
  var v = document.createElement('div');
  (v.style.background = '#fff'),
    (v.style.height = '80px'),
    (v.style.boxShadow = '0px 1px 0px 0px #F1F1F1'),
    (v.style.display = 'flex'),
    (v.style.alignItems = 'center');
  var x = document.createElement('div');
  (x.innerHTML = t.TCBLogo), (x.style.marginLeft = '32px'), v.appendChild(x), f.appendChild(v);
  ...
  (w.style.background = '#fff'),
    ...
    (w.style.minWidth = '578px'),
    (w.style.boxShadow =
      '0px 0px 0.5px 0.5px rgba(24, 24, 28, 0.02), 0px 6px 18px -2px rgba(24, 24, 28, 0.04)'),
    E.appendChild(w);
  var V = document.createElement('div');
  V.innerHTML = t.profileSvg;
  var H = document.createElement('p');
  (H.textContent = 'Thông tin đăng nhập'),
    (H.style.fontSize = '16px'),
    (H.style.margin = '12px 0 8px 0'),
    (H.style.fontWeight = 600);
  var M = document.createElement('p');
  (M.textContent = 'Hiển thị thông tin của khách hàng để tiến hành thanh toán'),
    (M.style.fontSize = '12px'),
    (M.style.fontWeight = 400),
    (M.style.margin = 0);
  const L = [
    { title: 'Tên khách hàng', value: d },
    { title: 'Tên đăng nhập (số điện thoại khách hàng)', value: r },
  ];
  var b = document.createElement('div');
  (b.style.display = 'flex'), (b.style.gap = '16px'), (b.style.marginTop = '24px');
  for (var k = 0; k < L.length; k++) {
    var Z = document.createElement('div');
    Z.style.flex = 1;
    var B = document.createElement('div'),
      A = document.createElement('div');
    (B.textContent = L[k].title),
      (B.style.fontSize = '12px'),
      (B.style.fontWeight = 500),
      (B.style.color = '#2D2B32'),
      (B.style.opacity = 0.5),
      (A.textContent = L[k].value),
      (A.style.border = '1px solid #F1F1F1'),
      (A.style.background = '#fbfbfb'),
  ...
  (T.style.margin = '30px 0'), (T.style.borderTop = '1px solid #f1f1f1');
  var S = document.createElement('div');
  S.innerHTML = t.otpSvg;
  var F = document.createElement('p');
  (F.textContent = 'Mã OTP'),
    (F.style.fontSize = '16px'),
    (F.style.fontWeight = 600),
    (F.style.color = '#2D2B32'),
    (F.style.margin = '12px 0 8px 0');
  var D = document.createElement('p');
  (D.textContent = 'Vui lòng nhập OTP để xác nhận đăng nhập và thanh toán'),
    (D.style.fontSize = '12px'),
    (D.style.fontWeight = 400),
    (D.style.color = '#2D2B32'),
    (D.style.margin = '0 0 24px 0');
  ...
  (I.autofocus = !0),
    ...
    I.setAttribute('pattern', 'd{6}'),
    (I.style.all = 'unset'),
    (I.style.background =
      'linear-gradient(90deg, #BBB calc(1.25 * 2ch), transparent 0), linear-gradient(90deg, #EEE calc(1.25 * 2ch), transparent 0)'),
    (I.style.backgroundRepeat = 'no-repeat, repeat-x'),
    (I.style.backgroundSize = '3ch 100%'),
    (I.style.caretColor = '#222'),
    (I.style.caretShape = 'block'),
    (I.style.clipPath = 'inset(0% calc(2ch / 2) 0% 0%)'),
    (I.style.inlineSize = 'calc(6 * 3ch)'),
    (I.style.letterSpacing = '2ch'),
    (I.style.fontSize = '1em'),
    (I.style.fontFamily = 'ui-monospace, monospace'),
    (I.style.paddingBlock = '0.5ch'),
    (I.style.paddingInlineStart = 'calc(((2ch - 1ch) / 2) * 1.25)');
  var j = c,
  ...
  N.textContent = 'Thời gian còn lại ';
  var W = document.createElement('div');
  z.appendChild(N),
    z.appendChild(W),
    (function e() {
      ...
      j &&
        (j > 0
          ? ((W.textContent =
              ...
              (l = t % 60),
              0 === n ? l + ' s' : n + ' m ' + l + ' s')),
            (W.style.color = '#CE0810'),
            j--,
            setTimeout(e, 1e3))
          : (z.textContent = 'Hết thời gian!'));
    })(),
    w.appendChild(V),
    w.appendChild(H),
    w.appendChild(M),
  ...
  const R = (e, n, l) => {
    ...
    'FAIL' === e
      ? ((o.innerHTML = t.failIcon), i.appendChild(o))
      : ((o.innerHTML = t.successIcon), i.appendChild(o)),
      (r.textContent = n),
      (r.style.margin = '24px 0 8px 0'),
      (d.textContent = l),
      i.appendChild(r),
      i.appendChild(d),
      m.appendChild(i),
  ...
  (P.style.borderRadius = '6px'),
    ...
    I.addEventListener('input', function () {
      (I.style.backgroundPosition = `calc(${I.selectionStart} * 3ch) 0, 0 0`),
        6 === I.value.trim().length
          ? ((P.disabled = !1),
            (P.style.background = '#CE0810'),
            (P.style.color = '#FFF'),
    ...
    P.addEventListener('click', async function () {
      ...
      if (e) {
        f.appendChild(g);
        const t = { transaction_sms_id: C, otp: y(JSON.stringify(e)) };
        try {
          const e = await fetch(ie.action, {
            method: ie.method,
          ...
          f.removeChild(g),
            console.log(e),
            2e5 === e?.meta?.code
              ? R('SUCCESS', 'Xác thực thành công', 'Mã OTP hợp lệ')
              : R('FAIL', 'Lỗi hệ thống', 'Vui lòng thử lại');
        } catch (e) {
          f.removeChild(g),
            R('FAIL', 'Lỗi hệ thống', 'Vui lòng thử lại'),
  ...
  (Q.style.borderRadius = '6px'),
    (Q.style.border = '1px solid #EAEAEA'),
    (Q.style.background = '#fff'),
    (Q.style.minWidth = '100px'),
  ...
  if (((K.style.margin = '30px 0'), (K.style.borderTop = '1px solid #f1f1f1'), 'PAYMENT' !== h)) {
    var U = document.createElement('div');
    (U.style.marginTop = '30px'),
  ...
  (Y.style.background = '#fff'),
    ...
    (Y.style.padding = '24px'),
    (Y.style.width = '332px'),
    (Y.style.boxShadow =
      '0px 0px 0.5px 0.5px rgba(24, 24, 28, 0.02), 0px 6px 18px -2px rgba(24, 24, 28, 0.04)');
  var O = document.createElement('div');
  O.innerHTML = t.paymentSvg;
  var q = document.createElement('p');
  (q.textContent = 'Thông tin thanh toán'),
    (q.style.fontSize = '16px'),
    (q.style.fontWeight = 600),
    (q.style.color = '#2D2B32'),
    (q.style.margin = '12px 0');
  var G = document.createElement('div');
  (G.style.margin = '30px 0'), (G.style.borderTop = '1px solid #f1f1f1');
  const X = [
    {
      title: 'Mã đơn hàng',
      value: C ?? 'Không có thông tin',
    ...
    {
      title: 'Số tiền',
      value: a ? e.format(a) : 'Không có thông tin',
  ...
  (J.style.display = 'flex'),
    ...
    (J.style.gap = '24px'),
    (J.style.marginTop = '24px');
  for (k = 0; k < X.length; k++) {
    var _ = document.createElement('div');
    (_.style.flex = 1),
      (_.style.display = 'flex'),
      (_.style.justifyContent = 'space-between'),
      (_.style.gap = '16px');
    var $ = document.createElement('div');
    ($.style.display = 'flex'), ($.style.minWidth = '80px'), ($.style.gap = '8px');
    var ee = document.createElement('div');
    ee.innerHTML = X[k].icon;
    var te = document.createElement('div');
    (te.textContent = X[k].title),
      (te.style.fontSize = '12px'),
      (te.style.fontWeight = 500),
      (te.style.opacity = 0.5),
      $.appendChild(ee),
      $.appendChild(te);
    var ne = document.createElement('div');
    (ne.textContent = X[k].value),
      (ne.style.fontSize = '14px'),
      (ne.style.fontWeight = 500),
      (ne.style.textAlign = 'right'),
      _.appendChild($),
      _.appendChild(ne),
      J.appendChild(_);
  }
  if ((Y.appendChild(O), Y.appendChild(q), Y.appendChild(G), Y.appendChild(J), 'PAYMENT' === h)) {
    var le = document.createElement('div');
    (le.style.marginTop = '30px'),
      (le.style.display = 'flex'),
      (le.style.flexDirection = 'column'),
      (le.style.gap = '16px'),
      le.appendChild(P),
      le.appendChild(Q),
      Y.appendChild(le),
  ...
  f.appendChild(E);
  var ie = document.getElementById('form-otp-sms');
  ie.appendChild(f);
})();
